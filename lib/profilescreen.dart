            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildMenuItem(Icons.notifications_none_outlined, 'Drink Reminder'),
                      _buildMenuItem(Icons.water_drop_outlined, 'Sipnudge Bottle'),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      _buildMenuItem(Icons.bar_chart_outlined, 'Data & Analytics'),
                      _buildMenuItem(Icons.security_outlined, 'Account & Security'),
                      _buildMenuItem(Icons.link_outlined, 'Linked Accounts'),
                      _buildMenuItem(Icons.help_outline, 'Help & Support'),
                      _buildMenuItem(Icons.logout_outlined, 'Logout', isRed: true),
                    ],
                  ),
                ),
              ),
