...
class _HomeAnalysisPageState extends State<HomeAnalysisPage> {
                ...
                children: [
                                        ...
                                        children: ['Weekly', 'Monthly', 'Yearly'].map((period) {
                                          ...
                                          return Expanded(
                                            child: GestureDetector(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                  color: isSelected ? const Color(0xFFA964E0) : Colors.transparent,
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        padding: EdgeInsets.only(left: screenHeight * 0.007.w, right: screenHeight * 0.007.w),
                        decoration: BoxDecoration(
  ...
  BarChartGroupData _buildBarGroup(int x, double y, double screenWidth) {
    return BarChartGroupData(
      ...
      showingTooltipIndicators: tappedIndex == x 
          ? [0] 
          : [],
    );
  }
    ...
    return Row(
      children: [
        Container(
          ...
          decoration: BoxDecoration(color: color, shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(3.r)),
        ),
 ...
 Widget _buildNavItem(IconData icon, String label, bool isActive) {
              ...
              child: Stack(
                ...
                children: [
                      ...
                      titlesData: FlTitlesData(
                        ...
                        leftTitles: AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            getTitlesWidget: (value, meta) {
                              return (value % 20 == 0)
                                  ? Text('${value.toInt()}%', style: TextStyle(color: Colors.white, fontSize: screenWidth * 0.025))
                                  : const Text('');
                            },
                          ),
                        ),
                  ...
                  if (tappedIndex != null)
                    Positioned(
                      top: 2,
                      left: screenWidth * (0.09 + tappedIndex! * 0.10), // Adjust for position
                      child: CustomTooltip(percentage: _getValueByIndex(tappedIndex!)),
                    ),
                ],
              ),
            ),
  ...
  Widget _chartIcon(double screenWidth, IconData icon, bool isActive) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          color: isActive ? const Color(0xFFB586BE) : Colors.white.withOpacity(0.2),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFF2196F3), width: screenWidth * 0.015),
                ),
                child: Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('100%',
                          style: TextStyle(color: Colors.white, fontSize: screenWidth * 0.05, fontFamily: 'Urbanist-Bold')),
                      Text('Water Intake',
                          style: TextStyle(color: Colors.white, fontSize: screenWidth * 0.025, fontFamily: 'Urbanist-Medium')),
                    ],
                  ),
                ),
              ),
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildLegendItem('Water (80%)', const Color(0xFF2196F3), screenWidth),
                  SizedBox(height: screenHeight * 0.01),
                  _buildLegendItem('Food (20%)', const Color(0xFFE91E63), screenWidth),
                ],
              )
            ],
          ),
