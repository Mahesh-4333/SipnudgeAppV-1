...
class _SignInPage extends State<SignInPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _handleSignIn() async {
    ...
    await Future.delayed(const Duration(seconds: 2)); // Reduced from 20 to 2 seconds for better UX
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildLabel('Email'),
                          SizedBox(height: 8.h),
                          _buildInputField('assets/email.png', 'Email',
                              _emailController),
  ...
  Widget _buildInputField(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isPassword && _isPasswordInvalid
            ? Border.all(color: Color(0xFFFE4848), width: 2.w)
            : null,
      ),
      child: TextFormField(
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final gradient = SweepGradient(
      ...
      colors: const [
        ...
        Colors.transparent,  // Gap at the end
        Colors.transparent,  // Maintain gap
      ],
      stops: const [0.0, 0.3, 0.6, 0.85, 0.86, 1.0],
