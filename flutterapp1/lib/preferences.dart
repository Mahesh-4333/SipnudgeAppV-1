                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          _buildToggleTile('Haptic Feedback', hapticFeedback, (value) {
                            setState(() => hapticFeedback = value);
                          }),
                          SizedBox(height: 12.h),
                          _buildToggleTile('Wake-up Time as Alarm', wakeUpAlarm, (value) {
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('Restart All Tracking',
                        style: TextStyle(
    ...
    children: [
      ...
      Switch(
        ...
        thumbIcon: MaterialStateProperty.resolveWith<Icon?>(
          (Set<MaterialState> states) => Icon(null, size: 360.r),
        ),
      ),
    ],
  );
