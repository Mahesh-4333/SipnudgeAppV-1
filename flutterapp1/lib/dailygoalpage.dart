                  ...
                  child: SizedBox(
                    ...
                    child: WaveWidget(
                      config: CustomConfig(
                        ...
                        //durations: [12000, 12000, 12000, 12000] ,
                        durations: [12000, 8000, 6000, 4000],
              ...
              Padding(
                ...
                child: SliderTheme(
                  ...
                  child: Slider(
                    ...
                    value: waterAmount,
                    onChanged: (value) =>
                        setState(() => waterAmount = value),
                  ),
                ),
              ),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.085, vertical: screenHeight * 0.015),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("1L", style: TextStyle(fontSize: screenWidth * 0.035, color: const Color(0x40FFFFFF), fontFamily: 'Urbanist-Medium')),
                    Text("2L", style: TextStyle(fontSize: screenWidth * 0.035, color: const Color(0x40FFFFFF), fontFamily: 'Urbanist-Medium')),
                    Text("2.5L", style: TextStyle(fontSize: screenWidth * 0.035, color: const Color(0x40FFFFFF), fontFamily: 'Urbanist-Medium')),
                    Text("3L", style: TextStyle(fontSize: screenWidth * 0.035, color: const Color(0x40FFFFFF), fontFamily: 'Urbanist-Medium')),
                    Text("3.7L", style: TextStyle(fontSize: screenWidth * 0.035, color: Color(0x40FFFFFF), fontFamily: 'Urbanist-Medium')),
                  ],
                ),
              ),
...
class GradientSliderTrackShape extends SliderTrackShape {
  ...
  Rect getPreferredRect({
    ...
    final double thumbWidth =
        sliderTheme.thumbShape?.getPreferredSize(isEnabled, isDiscrete).width ?? 0;
