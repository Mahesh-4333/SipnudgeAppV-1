...
class PercentageRingPainter extends CustomPainter {
  ...
  final Color startColor = Color(0xFFA200FF); // Intense Purple
  final Color endColor = Color(0x20000000);   // Transparent
  final Color backgroundColor = Color(0x05000000); // Dim gray
...
void paint(Canvas canvas, Size size) {
  ...
  for (int i = 0; i < segmentCount; i++) {
    ...
    paint.color = i < activeSegments
        ? Color.lerp(endColor, startColor, t)!
        : backgroundColor;

    final double startAngle = -math.pi / 2 + i * anglePerSegment + spacing * 0.01;
    canvas.drawArc(
